...
Within the EDAP's Databricks platform, data science capabilities are delivered through **Mosaic AI** — encompassing Model Serving, Feature Engineering (Unity Catalog feature tables), Vector Search, the AI Agent Framework, and AI Gateway.
...
- **CI/CD for ML** — Implement continuous integration and continuous deployment pipelines for model code, training pipelines, and deployment artefacts. The pipeline should include automated testing (unit tests, integration tests, model validation tests), security scanning, and governance checks. Models should be promoted through environments (dev — staging — production) with appropriate approval gates.
...
- **Governed** — Feature lineage, ownership, and access controls are managed through Unity Catalog, providing the same governance for features as for any other data asset.
...
*This document complements the Data Engineering Lifecycle and BI Lifecycle and is designed for an enterprise context. Last updated March 2026.*
